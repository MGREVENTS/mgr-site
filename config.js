...
const SITE_CONFIG = {
  ...
  weddingPage: {
    hero: {
      eyebrow: "MGR Wedding",
      title: "L'<em>évidence</em>,<br>un soir durant",
      subtitle: "Nous acceptons peu de mariages chaque année. Ceux-là, nous les portons entièrement — jusqu'au détail que personne ne remarquera.",
      videoId: "Iy-Wbd6jF5c",
    ...
    chapters: [
      { eyebrow: "01 · Cérémonie",     title: "L'instant suspendu",   text: "Une sonorisation qu'on oublie, des choix qui laissent toute la place à l'émotion.", photo: "assets/photos/wedding/ceremonie.webp" },
      { eyebrow: "02 · Vin d'honneur", title: "La parenthèse",        text: "Le temps que vos invités se retrouvent. Rien qui s'impose — juste ce qu'il faut.", photo: "assets/photos/wedding/vin-honneur.webp" },
      { eyebrow: "03 · Dîner",         title: "À table",              text: "Une salle qui respire, des discours servis à la seconde, l'énergie qui monte sans qu'on la voie venir.", photo: "assets/photos/wedding/diner.webp" },
      { eyebrow: "04 · Première danse",title: "Votre moment",         text: "Votre chanson, une lumière. Nous l'avons répétée sans vous le dire, pour que rien ne tremble.", photo: "assets/photos/wedding/premiere-danse.webp" },
      { eyebrow: "05 · Soirée",        title: "La nuit",              text: "On lit la salle plus qu'on ne la dirige. La piste ne se vide pas ; personne ne saurait dire pourquoi.", photo: "assets/photos/wedding/soiree.webp" },
    ],
    momentsTitle: "Quelques soirs",
    momentsIntro: "Pris sur le vif. Jamais rejoué.",
    moments: [
    ...
    // Remplace les formules tarifées — une seule proposition, sur mesure
    surMesure: {
      eyebrow: "La prestation",
      title: "Pas de formule",
      body: "Chaque mariage a son lieu, ses invités, son tempo — aucun ne se tarife à l'avance. Nous composons le vôtre à partir de ce qui compte pour vous, et de tout ce que vous ne penserez pas à demander.",
      cta: "Commencer la conversation",
    },
    testimonialsTitle: "Ce qu'il en reste",
    testimonials: [
      { quote: "L'ambiance était là toute la soirée, sans qu'on ait rien à demander. Il a fait danser toutes les générations. On recommande les yeux fermés.", name: "Anna O.", event: "Mariage", rating: 5 },
      { quote: "Nous l'avons rencontré par hasard, et tout a suivi. Il a lu la piste à la perfection. Surtout, il nous a aidés à préparer le moment où mon père a chanté — un souvenir que nous n'avions pas osé imaginer.", name: "Melissa T.", event: "Mariage", rating: 5 },
      { quote: "Il a compris nos goûts avant nous. Des effets justes, jamais de trop. Des souvenirs pour toujours.", name: "Alexandre V.", event: "Mariage", rating: 5 },
    ],
    faqTitle: "Questions fréquentes",
    faq: [
      { q: "Intervenez-vous partout en Île-de-France ?", a: "Oui — Paris et toute l'Île-de-France, et au-delà sur demande." },
      { q: "Peut-on choisir les musiques ?", a: "Nous construisons ensemble une trame — moments forts, must-play, no-play — et le DJ adapte à la salle le jour venu." },
      { q: "Que se passe-t-il en cas d'imprévu ?", a: "Un remplacement est assuré dans l'heure via notre réseau de DJs résidents. Votre soir n'est jamais menacé." },
      { q: "Comment commencer ?", a: "Écrivez-nous. Nous vous répondons nous-mêmes, et nous prenons le temps d'un vrai échange." },
    ],
  },
